        ...
        return new Promise((resolve, reject) => {
            webReader.readWebsite(this.#perksURL).then((data) => {
                ...
                PerkTable.childNodes.forEach(tableRow => {
                    ...
                    const URI_name          = nameA.attributes['href'].split("/").pop(); // Should only be 3% slower than arr[arr.length - 1]
                    ...
                    const perkData = {"URI_name": URI_name,"name": perkName, "iconURL": perkIcon, "characterName": characterName, "characterURL": characterLink, "characterImageURL": characterImage, "content": content};
